...
{% include image.html src='upbeat_wireframes.png' alt='Initial wireframes for the UpBeat app' caption='User flows and initial wireframes for the three modes of the UpBeat app' class='wide' %}
